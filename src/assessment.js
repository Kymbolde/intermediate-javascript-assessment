...
function subway(personName) {
	...
	function addIngredient(ingredient) {
		person.ingredients.push(ingredient);
		return person;
	};
...
function compareValues(param1, param2) {
	if (typeof param1 === typeof param2 && (param1 * 1) === (param2 * 1)) {
		return("Exact match");
	}
	else if (typeof param1 !== typeof param2 && (param1 * 1) === (param2 * 1)) {
